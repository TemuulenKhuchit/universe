...
--
-- Name: tmp_table; Type: TABLE; Schema: public; Owner: freecodecamp
--

CREATE TABLE public.tmp_table (
    tmp_table_id integer NOT NULL,
    name character varying(50) NOT NULL,
    column2 text
);


ALTER TABLE public.tmp_table OWNER TO freecodecamp;

--
-- Name: tmp_table_id_seq; Type: SEQUENCE; Schema: public; Owner: freecodecamp
--

CREATE SEQUENCE public.tmp_table_id_seq
    AS integer
    START WITH 1
    INCREMENT BY 1
    NO MINVALUE
...
ALTER TABLE public.tmp_table_id_seq OWNER TO freecodecamp;

--
-- Name: tmp_table_id_seq; Type: SEQUENCE OWNED BY; Schema: public; Owner: freecodecamp
--

ALTER SEQUENCE public.tmp_table_id_seq OWNED BY public.tmp_table.tmp_table_id;
...
--
-- Name: tmp_table tmp_table_id; Type: DEFAULT; Schema: public; Owner: freecodecamp
--

ALTER TABLE ONLY public.tmp_table ALTER COLUMN tmp_table_id SET DEFAULT nextval('public.tmp_table_id_seq'::regclass);
...
INSERT INTO public.planet VALUES (4, 'planet4', 4, NULL, NULL);
INSERT INTO public.planet VALUES (5, 'planet5', 5, NULL, NULL);
INSERT INTO public.planet VALUES (6, 'planet6', 6, NULL, NULL);
...
INSERT INTO public.planet VALUES (11, 'planet11', 5, NULL, NULL);
...
--
-- Data for Name: tmp_table; Type: TABLE DATA; Schema: public; Owner: freecodecamp
--

INSERT INTO public.tmp_table VALUES (1, 'name1', NULL);
INSERT INTO public.tmp_table VALUES (2, 'name2', NULL);
INSERT INTO public.tmp_table VALUES (3, 'name3', NULL);
...
--
-- Name: tmp_table_id_seq; Type: SEQUENCE SET; Schema: public; Owner: freecodecamp
--

SELECT pg_catalog.setval('public.tmp_table_id_seq', 3, true);
...
--
-- Name: tmp_table tmp_table_name_key; Type: CONSTRAINT; Schema: public; Owner: freecodecamp
--

ALTER TABLE ONLY public.tmp_table
    ADD CONSTRAINT tmp_table_name_key UNIQUE (name);


--
-- Name: tmp_table tmp_table_pkey; Type: CONSTRAINT; Schema: public; Owner: freecodecamp
--

ALTER TABLE ONLY public.tmp_table
    ADD CONSTRAINT tmp_table_pkey PRIMARY KEY (tmp_table_id);
